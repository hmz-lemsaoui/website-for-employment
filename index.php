        ...
        <!-- <main class="main"> -->
            ...
            <div class="home__container container grid">
                ...
                <script type="text/javascript">
                    let imagee = document.getElementById('imagechange');
                    let images = ['person2.png','person (1).png','person (3).png']
                    setInterval(function(){
                        let random = Math.floor(Math.random() * 3);
                        imagee.src = images[random];
                    }, 5000);
                </script>
            </section>
    <!--=============== SERVICES ===============-->
                                    ...
                                    <div class="dropdownsearch">
                                        ...
                                        <div class="dropdownsearch-listsearch">
                                            <ul><i class="fa-light fa-circle-info"></i>
                                                ...
                                                <li><i class="fas fa-heart">&nbsp;</i>Title</li>
                                                <li><i class="fas fa-lightbulb">&nbsp;</i>Author</li>
                                                <li><i class="fas fa-info">&nbsp;</i>Content</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="search">
                ...
                <div class="services__container grid">
                    ...
                    <?php while ($emploi = $getAllEmploi->fetch()){
                            if(isset($_SESSION['auth'])){
                                ...
                                <div>
                                <?php 
                                    if ($_SESSION['id'] == $emploi['id_auteur']){
                                        ?>
                                        Published By: <a href="profile.php?id=<?= $_SESSION['id']; ?>" class="button button-link"><?= $emploi['nom_auteur']; ?> <?= $emploi['prenom_auteur'];?></a>
                                        <p>On: <?= $emploi['date_publication']; ?></p>
                                        <?php
                                    }else{
                                        ?>
                                        Published By: <a href="profileacceder.php?id=<?= $emploi['id_auteur']; ?>" class="button button-link"><?= $emploi['nom_auteur']; ?> <?= $emploi['prenom_auteur'];?></a>
                                        <p>On: <?= $emploi['date_publication']; ?></p>
                                        <?php
                                    }?>
                                <?php
                            ...
                            ?>   
                                <div class="services__data">
                                    ...
                                    <p class="services__description"><?=$emploi['description']; ?></p>
                                <div>
                                 Published By: <a href="login.php" class="button button-link"><?= $emploi['nom_auteur']; ?> <?= $emploi['prenom_auteur'];?></a><br>
                                 <p>On: <?= $emploi['date_publication']; ?></p>
                                <?php
                                }
                                ?>
            ...
            <section class="app section container">
                <div class="app__container grid">
                    ...
                    <div class="app__data">
                        <h2 class="section__title-center">Watch Your Offers <br> At Any Time</h2>
                        <p class="app__description">With our app you can view the statistics of your Offer.
                            Look for the app now!</p>
