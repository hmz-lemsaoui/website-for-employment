  ...
  <?php
    ...
    if(isset($_FILES["image"]["name"])){
        ...
        if(!in_array($imageExtension, $validaImaeExtension)){
            ...
            $editEmploiOnWebsite = $bdd->prepare('SELECT image FROM user WHERE id=?');
            $editEmploiOnWebsite->execute(array($id));
            $updateimage = $editEmploiOnWebsite->fetch();
            
            
            echo "
            <script>
            doucment.location.href = '../test5';
            </script>";
            $_SESSION['image']=$updateimage['image'];
        }
    }
    ?>
                ...
                <div class="contentP">
                    <div class="leftP">
                        ...
                        <a href="mes-offres.php" class="button">My Offers</a>
                    </div>
                    <div class="rightP">
                        <div>
                            <h3 class="numberP"><?=$nbrOfOffers;?></h3>
