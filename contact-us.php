    ...
    <section class="form login">
      ...
      <form method="POST">
          ...
          ?>
            ...
            <div class="field input">
              <label><i class="fas fa-envelope"></i>Your E-mail</label>
              <input type="email" name="mail" placeholder="Your Email" value="<?php if(isset($_POST['mail'])) { echo $_POST['mail']; } ?>">
            </div>
            <div class="field input">
              <label><i class="fas fa-mobile"></i>Your phone number</label>
            ...
            <div class="field buttonn">
              <input type="submit" name="mailform" value="Send the message">
            </div>
      </form>
    </sectin>
  </div>
